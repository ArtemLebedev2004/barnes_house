<template>
    ...
    <swiper
        ...
        :class="menuButtons ? 'lg:hidden! max-w-[450px] menu_buttons mt-[calc(87px+2vw)] min-[450px]:mt-[96px] min-[768px]:max-w-[820px] min-[1024px]:max-w-full m-auto' : (achievs ? 'min-[768px]:max-w-[820px] min-[1024px]:max-w-full achievs mt-[8%] min-[768px]:mt-[4%] min-[820px]:mt-[32.8px]' : (Object.keys(imgs).length == 2 ? 'imgs imgs2' : 'imgs'))"
    >
        ...
        <template v-if="achievs">
            <swiper-slide v-for="achiev in achievs" :key="achiev" class="h-[71vw]! min-[450px]:h-[319.5px]! min-[768px]:h-auto! rounded-[7vw] min-[450px]:rounded-[48.15px] border-daorange border-2  px-[6.9%] min-[768px]:px-[4%] py-[6%] min-[768px]:py-[4%]">
                <div class="text-[8vw] min-[450px]:text-[36px] min-[768px]:text-[4vw] min-[820px]:text-[32.8px] text-daorange font-semibold">{{achiev.title}}</div>
                <div class="text-[3.9vw] min-[450px]:text-[17.5px] min-[768px]:text-[2.25vw] min-[820px]:text-[18.45px] min-[1024px]:text-[16px] font-light mt-[8%]" v-html="achiev.description"></div>
            </swiper-slide>
        </template>
