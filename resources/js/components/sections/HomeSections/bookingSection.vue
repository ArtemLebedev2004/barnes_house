<template>
    <div class="max-w-[450px] min-[768px]:max-w-[820px] px-4.5 min-[768px]:px-[23px] m-auto ">
        <div class="hidden min-[768px]:block mt-[75%]">
            ...
            <div class="flex justify-center mt-[7%] gap-[3.4vw]  text-[3.2vw] min-[820px]:text-[26.24px] font-light">
        ...
        <div class="min-[768px]:flex min-[768px]:mt-[7%] min-[768px]:gap-[5vw]">
            <div class="min-[768px]:w-[45%] relative border-daorange border-3 p-[3.5%] min-[768px]:p-[1.5%] rounded-[12.3vw] min-[450px]:rounded-[55.35px] mt-[140%] md:mt-0">
                <div class="relative">
                    ...
                    <div class=" absolute top-[5%] min-[768px]:top-[7%] font-light text-white inset-x-0 w-max text-center m-auto">
                        <div class="text-[4.5vw] min-[450px]:text-[20px]">
                            бронирование
                        </div>
                    ...
                    <div class="absolute left-[8%] min-[768px]:left-[10%] bottom-[5%] min-[768px]:bottom-[6%] text-white flex flex-col gap-[3.4vw] min-[450px]:gap-[15.3px]">
                        <div class="leading-[140%] w-[85%] text-[5.6vw] min-[450px]:text-[25.2px]">
                            <div class="w-max">
                        ...
                        <div class="min-[768px]:hidden bg-daorange w-[38%] h-[2px]">
                        </div>

                        <div class="min-[768px]:hidden font-light w-[70%] text-[11vw] min-[450px]:text-[49.5px] leading-[112%] text-daorange">
                            BARNES HOUSE
                        </div>
                    </div>
                </div>
            ...
            <div class="min-[768px]:w-[55%]">
                ...
                <div class="min-[768px]:h-full relative border-daorange border-2 py-10 px-9 rounded-[10vw] min-[450px]:rounded-[45px] mt-[12%] min-[768px]:mt-0 min-[768px]:flex flex-col justify-center">
                    <div class="absolute w-max inset-x-0 m-auto px-[4%] -top-[2.5%] bg-white text-[3.9vw] min-[450px]:text-[17.55px] text-daorange">ПЕРВЫЙ ВАРИАНТ</div>

                    <a href="tel:89374541087" class="block text-center font-semibold text-[4.8vw] min-[450px]:text-[21.6px] px-[69px] py-[5%] bg-daorange rounded-full text-white">
                        Позвонить
                    </a>

                    <div class="relative mt-[10%]">
                        <div class="absolute inset-0 h-px w-[60%] m-auto bg-daorange -z-1"></div>
                        <div class="w-max m-auto px-[3%] bg-white text-[3.9vw] min-[450px]:text-[17.55px] text-daorange">ИЛИ</div>
                    </div>

                    <div class="mt-[10%]">
                        <input type="text" name="Имя" required class="text-[4.5vw] min-[450px]:text-[20.25px] w-full border-2 xl:border-3 border-daorange text-center rounded-full py-[4%] px-4 outline-none placeholder:text-daorange" placeholder="Фамилия и Имя">
                        <input type="phone" name="Телефон" required class="text-[4.5vw] min-[450px]:text-[20.25px] w-full border-2 xl:border-3 border-daorange text-center rounded-full py-[4%] px-4 mt-[5%] outline-none placeholder:text-daorange" placeholder="Телефон">
                        ...
                        <div class="group mt-[7%] min-[768px]:mt-[9%]">
                            ...
                            <label for="check_circle" class="flex gap-[3.4vw] min-[450px]:gap-[15.3px] items-center">
                                <div class="w-[6vw] min-[450px]:w-[27px] h-[6vw] min-[450px]:h-[27px] rounded-[1.5vw] min-[450px]:rounded-[6.75px] border-2 xl:border-3 border-daorange group-has-checked:bg-white"></div>

                                <div class=" w-fit text-[3.9vw] min-[450px]:text-[17.55px] min-[768px]:text-[2.2vw] min-[820px]:text-[18px] leading-[130%]">
                                    <div class="relative">
                                        Даю согласие на обработку
                                        <div class="absolute top-[90%] right-[4%] bg-daorange w-[80%] h-px">
                                        </div>
                                    </div>
                        ...
                        <div class="mt-[7%] min-[768px]:mt-[9%] font-semibold text-[4.8vw] min-[450px]:text-[21.6px] text-center px-[30px] py-[5%] bg-daorange rounded-full text-white">
                            Заказать звонок
                        </div>
                    </div>
                </div>
        ...
        <div class="relative border-daorange border-2 p-[4%] min-[768px]:p-[3%] rounded-[10vw] min-[450px]:rounded-[45px] min-[768px]:rounded-[8vw] min-[820px]:rounded-[65.6px] mt-[12%] min-[768px]:mt-[6%]">
            <div class="absolute w-max inset-x-0 m-auto px-[4%] min-[768px]:px-[3%] -top-[2.8%] min-[768px]:-top-[2.2%] bg-white text-[3.9vw] min-[450px]:text-[17.55px] text-daorange">ВТОРОЙ ВАРИАНТ</div>

            <div class=" bg-daorange p-[7.3%] rounded-[7vw] min-[450px]:rounded-[31.5px] min-[768px]:rounded-[5.7vw] min-[820px]:rounded-[46.74px] text-white flex flex-col gap-[3.8vw] min-[450px]:gap-[17.1px] min-[768px]:gap-[3vw] min-[820px]:gap-[24.6px]">
                <div class="rounded-full flex items-center justify-between text-[2.8vw] min-[450px]:text-[12.6px] min-[768px]:text-[2.3vw] min-[820px]:text-[18.86px] border-white border-[2px] px-[6%] py-[5%] min-[768px]:py-[3.5%]">
                    <div id="calendar" class="w-[58%] min-[768px]:w-[64%] flex gap-[3.8vw] min-[450px]:gap-[17.1px] min-[768px]:gap-[3.5vw] min-[820px]:gap-[28.7px] items-center">
                    ...
                    <div @click="openCountOfPerson = !openCountOfPerson" class="relative w-[27%] min-[768px]:w-[22%] flex items-center justify-between">
                        ...
                        <div class="text-[2.8vw] min-[450px]:text-[12.6px] min-[768px]:text-[2.3vw] min-[820px]:text-[18.86px]">
                ...
                <form @submit.prevent="form.post('booking', {preserveScroll: true})" class="flex flex-col gap-[3.8vw] min-[450px]:gap-[17.1px] min-[768px]:gap-[3vw] min-[820px]:gap-[24.6px]" >
                    <input type="text" name="Имя" required v-model="form.name" class="w-full border-2  border-white text-[4.5vw] min-[450px]:text-[20.25px] min-[768px]:text-[3vw] min-[820px]:text-[24.6px] text-center rounded-full py-[5%] min-[768px]:py-[4.4%] px-4  outline-none placeholder:text-white" placeholder="Фамилия и Имя">
                    <input type="phone" name="Телефон" required v-model="form.phone" class="w-full border-2 border-white text-[4.5vw] min-[450px]:text-[20.25px] min-[768px]:text-[3vw] min-[820px]:text-[24.6px] text-center rounded-full py-[5%] min-[768px]:py-[4.4%] px-4   outline-none placeholder:text-white" placeholder="Телефон">

                    <div class="group">
                        <input id="check_circle" type="checkbox" class="hidden" >

                        <label for="check_circle" class="flex gap-[3.4vw] min-[450px]:gap-[15.3px] items-center">
                            <div class="w-[6vw] min-[450px]:w-[27px] h-[6vw] min-[450px]:h-[27px] rounded-[1.5vw] min-[450px]:rounded-[6.75px] border-2 border-white group-has-checked:bg-white"></div>

                            <div class=" w-fit min-[768px]:w-auto text-[3.9vw] min-[450px]:text-[17.55px] min-[768px]:text-[2.3vw] min-[820px]:text-[19.2px] leading-[130%] min-[768px]:flex min-[768px]:gap-[0.8vw] min-[820px]:gap-[6.56px]">
                                <div class="relative">
                                    Даю согласие на обработку
                                    <div class="absolute top-[90%] right-[4%] min-[768px]:right-0 min-[768px]:left-[17%] bg-white w-[80%] h-px">
                                    </div>
                                </div>
                    ...
                    <button type="submit" class="font-semibold text-[4.8vw] min-[450px]:text-[21.6px] min-[768px]:text-[3vw] min-[820px]:text-[24.6px] text-center px-[30px] py-[5%] min-[768px]:py-[4.9%] bg-white rounded-full text-daorange">
                        Забронировать
                    </button>
<!--
