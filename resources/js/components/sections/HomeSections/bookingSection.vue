<template>
    <div class="max-w-[450px] md:max-w-[820px] px-4.5 md:px-[23px] m-auto ">
        <div class="hidden md:block mt-[75%]">
            <div class=" mt-[12.5%] relative right-0 font-bold text-[9vw] leading-[120%] flex flex-col items-center">
                <div class=" w-max ">
                    Забронируйте
            ...
            <div class="flex justify-center mt-[7%] gap-[3.4vw]  text-[3.2vw] font-light">
        ...
        <div class="md:flex md:mt-[7%] md:gap-[5vw]">
            <div class="md:w-[45%] relative border-daorange border-3 p-[3.5%] md:p-[2%] rounded-[12.3vw] min-[450px]:rounded-[55.35px] mt-[140%] md:mt-0">
                <div class="relative">
                    ...
                    <div class="absolute top-[5%] font-light text-white inset-x-0 w-max text-center m-auto">
                        ...
                        <svg  viewBox="0 0 18 30" fill="none" xmlns="http://www.w3.org/2000/svg" class="m-auto mt-[6%] w-[6%]">
                    ...
                    <div class="absolute left-[8%] bottom-[5%] text-white flex flex-col gap-[3.4vw] min-[450px]:gap-[15.3px]">
                        ...
                        <div class="bg-daorange w-[38%] h-[2px]">
                        </div>

                        <div class="font-light w-[70%] text-[11vw] min-[450px]:text-[49.5px] leading-[112%] text-daorange">
                            BARNES HOUSE
                        </div>
                    </div>
                </div>
            ...
            <div class="md:w-[55%]">
                <div class="md:hidden mt-[12.5%] relative right-0 font-bold text-[11vw] min-[450px]:text-[49.5px] leading-[120%] flex flex-col items-end">
                    <div class=" w-max ">
                        Забронируйте
                        <div class="bg-daorange h-[2px]">
                        </div>
                ...
                <div class="md:hidden flex items-center mt-[10%] gap-[3.4vw] min-[450px]:gap-[15.3px] text-[3.9vw] min-[450px]:text-[17.55px] font-light">
                ...
                <div class=" relative border-daorange border-2 py-10 px-9 rounded-[10vw] min-[450px]:rounded-[45px] mt-[12%] md:mt-0">
                    ...
                    <div class="mt-[10%]">
                        ...
                        <div class="group mt-[7%] md:mt-[9%]">
                            ...
                            <label for="check_circle" class="flex gap-[3.4vw] min-[450px]:gap-[15.3px] items-center">
                                ...
                                <div class=" w-fit text-[3.9vw] min-[450px]:text-[17.55px] md:text-[1.8vw] leading-[130%]">
                                    <div class="relative">
                        ...
                        <div class="mt-[7%] md:mt-[9%] font-semibold text-[4.8vw] min-[450px]:text-[21.6px] text-center px-[30px] py-[5%] bg-daorange rounded-full text-white">
                            Заказать звонок
                        </div>
                    </div>
                </div>
        ...
        <div class="relative border-daorange border-2 p-[4%] rounded-[10vw] min-[450px]:rounded-[45px] mt-[12%]">
            <div class="absolute w-max inset-x-0 m-auto px-[4%] -top-[2.8%] bg-white text-[3.9vw] min-[450px]:text-[17.55px] text-daorange">ВТОРОЙ ВАРИАНТ</div>

            <div class=" bg-daorange p-[7.3%] rounded-[7vw] min-[450px]:rounded-[31.5px] text-white flex flex-col gap-[3.8vw] min-[450px]:gap-[17.1px]">
                <div class="rounded-full flex items-center justify-between text-[2.8vw] min-[450px]:text-[12.6px] border-white border-[2px] px-[6%] py-[5%]">
                    <div id="calendar" class="w-[58%] flex gap-[3.8vw] min-[450px]:gap-[17.1px] items-center">
                        <svg viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-[15.3%]">
                    ...
                    <div class="bg-white w-[2px] h-[25px]">

                    </div>

                    <div @click="openCountOfPerson = !openCountOfPerson" class="relative w-[27%] flex items-center justify-between">
                        ...
                        <div class="text-[2.8vw] min-[450px]:text-[12.6px]">
                            <span>{{activeCountOfPerson}}</span> ЧЕЛ.
                        </div>

                        <div v-if="openCountOfPerson" class="absolute bg-liorange w-full h-[1150%] text-center text-daorange text-[3.4vw] min-[450px]:text-[12.6px] overflow-auto rounded-xl top-[220%] z-1">
                            <div v-for="count in countOfPerson" :key="count" @click="activeCountOfPerson = count" class="py-2 border-daorange border-b last:border-b-0">
                                {{ count }}
                            </div>
                        </div>
                    </div>
                ...
                <form @submit.prevent="form.post('booking', {preserveScroll: true})" class="flex flex-col gap-[3.8vw] min-[450px]:gap-[17.1px]" >
                    <input type="text" name="Имя" required v-model="form.name" class="w-full border-2  border-white text-[4.5vw] min-[450px]:text-[20.25px] text-center rounded-full py-[5%] px-4  outline-none placeholder:text-white" placeholder="Фамилия и Имя">
                    <input type="phone" name="Телефон" required v-model="form.phone" class="w-full border-2 border-white text-[4.5vw] min-[450px]:text-[20.25px] text-center rounded-full py-[5%] px-4   outline-none placeholder:text-white" placeholder="Телефон">
                    ...
                    <div class="group">
                        ...
                        <label for="check_circle" class="flex gap-[3.4vw] min-[450px]:gap-[15.3px] items-center">
                            ...
                            <div class=" w-fit text-[3.9vw] min-[450px]:text-[17.55px] leading-[130%]">
                                <div class="relative">
                                    Даю согласие на обработку
                                    <div class="absolute top-[90%] right-[4%] bg-white w-[80%] h-px">
                                    </div>
                                </div>
                    ...
                    <button type="submit" class="font-semibold text-[4.8vw] min-[450px]:text-[21.6px] text-center px-[30px] py-[5%] bg-white rounded-full text-daorange">
                        Забронировать
                    </button>
<!--
